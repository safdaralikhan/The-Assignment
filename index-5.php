...
<!-- Mirrored from digimark.themetags.com/index-5.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Feb 2021 12:21:29 GMT -->
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <section class="hero-equal-height ptb-70">
        <div class="hero-shape hero-shape-none-sm" style="background: url('img/t5-hero-shape.svg')no-repeat top right"></div>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-12 col-lg-6">
                    <div class="img-wrap">
                        <img src="img/t5-hero-img.svg" alt="hero" class="img-fluid custom-width">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-3 promo-col">
                    <div class="promo-item">
                        <div class="promo-img">
                            <img src="img/increase.svg" alt="prevention" width="75">
                        </div>
                ...
                <div class="col-md-6 col-lg-3 promo-col">
                    <div class="promo-item">
                        <div class="promo-img">
                            <img src="img/interface.svg" alt="prevention" width="75">
                        </div>
                        <h5>Page Rankings</h5>
                        <p>Wash your hands frequently more then 20s</p>
                    </div>
                ...
                <div class="col-md-3 col-sm-6 promo-col">
                    <div class="promo-item">
                        <div class="promo-img">
                            <img src="img/search-engine.svg" alt="prevention" width="75">
                        </div>
                ...
                <div class="col-md-3 col-sm-6 promo-col">
                    <div class="promo-item">
                        <div class="promo-img">
                            <img src="img/consult.svg" alt="prevention" width="75">
                        </div>
...
<!-- Mirrored from digimark.themetags.com/index-5.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Feb 2021 12:21:31 GMT -->
</html>