                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-9 col-lg-7">
                        <div class="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
                            <h2 class="text-white animate__animated animate__heartBeat ">Religious Beliefs and Values Level 4
...
<br>
        <!--promo section start-->
        <div class="container">
            <h3 class="text-center">Report on Religious Beliefs and Values Level 4
            </h3>
           <h5>Introduction</h5>
            ...
            <h4>Objective of research</h4>
            <p>1) To analyse the concept of religiosity.</p>
            <p>2) To determine the importance of religiosity for psychological well being of middle aged to the elderly people.</p>
            <p>3) To examine the impact of religious aspects on psychological health of middle aged people.</p>
            <br>

            <h4>Questions of the research</h4>
            <p>1) How to analyse the concept of religiosity?</p>
            <p>2) What is the importance of religiosity for psychological well being of middle aged to the elderly people?</p>
            <p>3)How to examine the impact of religious aspects on psychological health of middle aged people?</p>
            <br>
