...
<!-- Mirrored from digimark.themetags.com/index-7.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Feb 2021 12:21:31 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse h-auto" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto menu">
                    ...
                    <li><a href="#" class="btn solid-white-btn check-btn">Free Check</a></li>
                </ul>
            </div>
        </div>
    </nav>
...
<div class="main">
    ...
    <!--hero section start-->
    <section class="hero-equal-height ptb-70" style="background: url('img/hero-bg-1.jpg')no-repeat center center / cover">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-12 col-lg-5">
                    <div class="hero-slider-content text-white pt-4">
                        <span>Digital Marketing</span>
                        <h1 class="text-white">Black Friday Super Sale Offer!</h1>
                        <p class="lead">Up to 90% OFF digital marketing plans. Hurry up, limited time offer is ticking down, the deal ends in:</p>
                        <ul id="countdown" class="list-inline countdown-list">
                            <li class="list-inline-item text-center"><h6 id="days" class="white-bg rounded"></h6><span>Days</span></li>
                            <li class="list-inline-item text-center"><h6 id="hours" class="white-bg rounded"></h6><span>Hours</span></li>
                            <li class="list-inline-item text-center"><h6 id="minutes" class="white-bg rounded"></h6><span>Minutes</span></li>
                            <li class="list-inline-item text-center"><h6 id="seconds" class="white-bg rounded"></h6><span>Seconds</span></li>
                        </ul>
                ...
                <div class="col-md-12 col-lg-7">
                    <div class="offer-tag-wrap mt-4 mt-sm-4 mt-md-0 mt-lg-0">
                        <div class="position-relative">
                            <img src="img/hero-offer-img.svg" alt="offer tag" class="img-fluid">
                        </div>
                        <div class="offer-tag text-center">
                            ...
                            <a href="offer-single-page.php" class="btn outline-white-btn mt-4">Get Start Now</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="about-us-img">
                        <img src="img/t1-hero-img.svg" alt="about us" class="img-fluid about-single-img">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="services-single text-center p-5 my-md-3 my-lg-3 my-sm-0 shadow-sm white-bg rounded">
                        ...
                        <p class="mb-0">Progressively empower business "outside the box" thinking with resource-leveling
                            partnerships.</p>
                        <a href="services-details.php" target="_blank" class="detail-link mt-4">Read more <span
