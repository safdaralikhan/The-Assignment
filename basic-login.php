...
<!-- Mirrored from digimark.themetags.com/basic-login.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Feb 2021 12:21:32 GMT -->
<head>
    <meta charset="utf-8">
                ...
                <div class="col-md-5 col-lg-5">
                    <div class="card login-signup-card shadow-lg mb-0">
                        ...
                        <div class="card-footer bg-transparent border-top px-md-5"><small>Not registered?</small>
                            <a href="sign-up.php" class="small"> Create account</a></div>
                    </div>
                </div>
            </div>
        </div>
