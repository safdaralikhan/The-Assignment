...
<!-- Mirrored from digimark.themetags.com/index-4.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Feb 2021 12:21:28 GMT -->
                    ...
                    <ul class="navbar-nav ml-auto menu">
                        <li><a href="#" class="dropdown-toggle"> Home</a>
                            <ul class="sub-menu">
                                ...
                                <li><a href="index-7.php">Home Page 07 <span
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-6">
                                            <div
                                                ...
                                                <p class="mb-0">Progressively empower business "outside the box"
                                                    ...
                                                    partnerships.</p>
                                                <a href="services-details.php" target="_blank"
                    ...
                    <div class="col-md-12">
                        <div class="text-center pb-2">
                            ...
                            <button type="button" class="filter-btn" data-mixitup-control
                                data-filter=".branding">Marketing Strategy</button>
                            <button type="button" class="filter-btn" data-mixitup-control
                                data-filter=".animation">Content Marketing</button>
                                ...
                                <div class="post-meta mb-2">
                                    <ul class="list-inline meta-list">
                                        ...
                                        <li class="list-inline-item"><i
                                                class="fas fa-share-alt mr-2"></i><span>10</span> Share</li>
                                    </ul>
                                </div>
                            ...
                            <div class="overlay d-flex align-items-center justify-content-center">
                                <div class="overlay-inner">
                                    ...
                                    <p class="teacher-see-profile">
                                        <a href="#" class="btn outline-white-btn">Hire Me</a>
                                    </p>
                                </div>
                            </div>
                        </div>
...
Graduated from Cape Breton University US  </span>
                            ...
                            <div class="overlay d-flex align-items-center justify-content-center">
                                <div class="overlay-inner">
                                    ...
                                    <h5 class="mb-0 teacher text-white"> Claudia Jaime </h5>
                                    <span class="teacher-field text-white">
                                ...
                                <div class="footer-nav-wrap text-white">
                                    ...
                                    <ul class="get-in-touch-list">
                                        <li class="d-flex align-items-center py-2"><span
                                                class="fas fa-map-marker-alt mr-2"></span> 1234 Street Name, City Name,
                                            USA
                                        </li>
                                        <li class="d-flex align-items-center py-2"><span
...
<!-- Mirrored from digimark.themetags.com/index-4.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Feb 2021 12:21:29 GMT -->
