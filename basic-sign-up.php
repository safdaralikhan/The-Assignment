...
<!-- Mirrored from digimark.themetags.com/basic-sign-up.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Feb 2021 12:21:32 GMT -->
<head>
    <meta charset="utf-8">
...
<header class="header">
    ...
    <nav class="navbar navbar-expand-lg fixed-top bg-transparent">
        <div class="container">
            <a class="navbar-brand" href="index-5.php">
                            ...
                            <form class="login-signup-form">
                                ...
                                <div class="my-4">
                                    <div class="custom-control custom-checkbox mb-3">
                                        ...
                                        <label class="custom-control-label" for="check-terms">I agree to the <a href="#">Terms & Conditions</a></label>
                                    </div>
                                </div>
