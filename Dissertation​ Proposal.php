<?php include "header.php"; ?>
    ...
    <div class="main">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-6 col-lg-12">
                        <div class="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
                            <h1 class="text-white heartBeat">Dissertation​ Proposal
                            </h1>
        ...
        <!--hero section end-->
        <div class="container">
            <h3 class="text-center ">Report on Dissertation​ Proposal
            </h3>
            <br>
            <h5>Introduction</h5>
...
<div class="row ">
    <div class="col-md-6">
    <p>a: Provides low fares to students</p>
...
<br>
<p>Interpretation: As per the above described table, it can be analysed that Trabsport for London is essential Theme 3: Transport for London helps in making travelling easier for students</p>
<br>
<div class="row ">
    <div class="col-md-6">
    <p>
Q3: Does Transport for London focuses on reducing pollution to become sustainable in London?</p>
...
<div class="row ">
    <div class="col-md-6">
    <p>b:  Borrowing and cash movements</p>
...
<div class="row ">
    <div class="col-md-6">
    <p>c:  funds from Department for Transport (DfT)</p>
