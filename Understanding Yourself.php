<?php include "header.php"; ?>
    ...
    <div class="main">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-6 col-lg-12">
                        <div class="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
                            <h1 class="text-white heartBeat">Understanding Yourself and Others
        ...
        <!--hero section end-->
        <div class="container">
            <h3>Report on Understanding Yourself and Others</h3>
            <br>
...
<br>
            <p>Reflective Personal Development Plan Journal</p>
            <h5>REFLECTIVE JOURNAL ENTRY PRO-FORMA 1</h5>
            
            <p>
            <strong>What is the core skill to develop?</strong>  According to perception of…, it has been analysed that to have a good position or high rank in an organisation one must have Time management skills. It refers to manage time in a proper manner so that for doing every task a right time is been set. This helps a person in doing effective planning and setting targets and goals of an organisation. Moreover it makes an individual punctual.</p>
            <br>
...
<h5>REFLECTIVE JOURNAL ENTRY PRO-FORMA 2</h5>
           ...
           <h5>REFLECTIVE JOURNAL ENTRY PRO-FORMA 3</h5>
            ...
            <br>
               ...
               <br>
               <h5>REFLECTIVE JOURNAL ENTRY PRO-FORMA 4</h5
               >
               <br>
               <p><strong>What is core skill?</strong>  According to opinion of …, it has been determined that negotiation skill is required by a candidate to present himself in front of panel during interview process. Negotiation is a process through which individuals settle out their differences. Through this a compromise is done or an conclusion is being found out while neglecting conflicts or arguments. In case if one party does not agree to another than they find out ways to come to an outcome to which both party agrees. The process of negotiation includes various stages which are preparation, discussion, clarification of goals, negotiate towards a win win outcome, agreement and implementation of a course of action.</p>
               <br>
  ...
  <thead>
    <tr>
        <th></th>
      <th scope="col" ><strong>Development area</strong>
</th>
      <th scope="col"><strong>Specific</strong>   </th>
      <th scope="col"><strong>Measurable</strong> </th>
      <th scope="col"><strong>Attainable</strong> </th>
      <th scope="col"><strong> Relevant</strong></th>
      <th scope="col"><strong> Timely</strong></th>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <td> Skills	Under this process, I seek to develop my communicating abilities.</td>
      <td>By taking business management classes</td>
      <td>These kind of actions are attainable by carrying out daily practices.</td>
      <td>This will help in making effective negotiation with clients on specific contracts.</td>
      <td>4 months</td>
    </tr>
    <tr>
      <th scope="row"></th>
      <td>Resilience</td>
      <td>I have to develop this skill</td>
      <td>By developing a strong social network.</td>
      <td>It can be achieved by working with experts</td>
      <td>This will help in overcoming from adverse situations and trauma of life</td>
      <td>6 month</td>
    </tr>
    <tr>
      <th scope="row"></th>
      <td>Time Management</td>
      <td>In order to complete a project, I have to develop time managerial skill</td>
      <td>Taking time management classes from affiliated institutes.</td>
      <td>By working in group-related activities.</td>
      <td>This will help me completing project on time.</td>
      <td>3 months</td>
    </tr>
  </tbody>
</table>
